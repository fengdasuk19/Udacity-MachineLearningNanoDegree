...
class LearningAgent(Agent):
    ...
    def build_state(self):
        ...
        state = (waypoint, inputs['light'], deadline) #  (waypoint, inputs['light'], deadline)#(waypoint, inputs['light'], deadline)  #(inputs['light'], inputs['left'],inputs['right'], inputs['oncoming']) # 
...
def run():
    ...
    sim.run(n_test=200, tolerance=math.pow(200, -2))#0.1
